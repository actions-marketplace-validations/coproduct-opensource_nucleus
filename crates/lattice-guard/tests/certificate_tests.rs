...
fn arb_capability_lattice() -> impl Strategy<Value = lattice_guard::CapabilityLattice> {
    (
        ...
        .prop_map(
            |(
                ...
                lattice_guard::CapabilityLattice {
                    read_files,
                    write_files,
                    edit_files,
                    run_bash,
...
fn perms_from_caps(caps: lattice_guard::CapabilityLattice) -> PermissionLattice {
    PermissionLattice {
        capabilities: caps,
        ..Default::default()
    }
